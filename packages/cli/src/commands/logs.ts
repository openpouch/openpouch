...
import { logsSummary, stripAnsi } from "../summary.js";
...
export async function logsCommand(
  ...
  try {
    // Strip ANSI color codes from log messages — build/runtime tools emit them,
    // and they're noise in `--json` output and in relayed text (OpenClaw 2026-06-29).
